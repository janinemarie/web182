...
$number2 = -105.33;
$number3 = 0.0049;
$message = 'Enter some numbers of your own and click the Submit button.';
...
switch ($action) {
    case 'process_data':
        ...
        if ($message !== 'Please enter three valid numbers.') {
            ...
            $message =
                ...
                $goBack = "<a href=\"index.php\">Clear this and start again.</a> ";
        }
